module.exports = {
  ...
  pages: {
    ...
    technology: {
      ...
      meta: {
        en: {
          title: 'On-prem private AI architecture · Smart Fellow',
        ...
        fr: {
          title: "Architecture IA privée sur site · Smart Fellow",
        ...
        ko: {
          title: '사내 전용 AI 아키텍처 · Smart Fellow',
    ...
    sovereign: {
      ...
      meta: {
        en: {
          title: 'Sovereign · offline AI for confidential work',
        ...
        fr: {
          title: 'Sovereign · IA hors ligne confidentielle',
        ...
        ko: {
          title: 'Sovereign · 기밀 업무용 오프라인 AI',
    ...
    'use-cases': {
      path: '/use-cases/',
      template: 'use-cases.template.html',
      output: 'use-cases/index.html',
      meta: {
        en: {
          title: 'Use cases · Smart Fellow',
          description: 'Real Smart Fellow builds. Each use case shows how a private AI team takes shape inside a specific company in Korea.',
          ogTitle: 'Smart Fellow use cases',
          ogDescription: 'Each Smart Fellow build is shaped by the company that runs it. Read how real teams operate.'
        },
        fr: {
          title: "Cas d'usage · Smart Fellow",
          description: "Des cas réels Smart Fellow. Chaque cas montre comment une équipe IA privée prend forme dans une entreprise précise en Corée.",
          ogTitle: "Cas d'usage Smart Fellow",
          ogDescription: "Chaque build Smart Fellow est façonné par l'entreprise qui le fait tourner. Lisez comment de vraies équipes opèrent."
        },
        ko: {
          title: '도입 사례 · Smart Fellow',
          description: '실제 Smart Fellow 구축 사례. 한국의 한 회사 안에서 전용 AI 팀이 어떻게 자리 잡는지 보여 드립니다.',
          ogTitle: 'Smart Fellow 도입 사례',
          ogDescription: '모든 Smart Fellow 구축은 회사에 맞춰 모양을 잡습니다. 실제 팀이 어떻게 운영되는지 읽어보세요.'
        }
      }
    },
    'use-cases-studio-monjo': {
      ...
      meta: {
        en: {
          title: 'Studio Monjo · AI team for a Seoul studio',
          description: 'Studio Monjo runs a Seoul studio on one Smart Fellow machine, with five AI teammates working in Telegram, Notion, Drive, KakaoMap, and law.go.kr.',
        ...
        fr: {
          title: 'Studio Monjo · équipe IA à Séoul',
          description: "Studio Monjo fait tourner un studio de Séoul sur une seule machine Smart Fellow, avec cinq collègues IA dans Telegram, Notion, Drive et KakaoMap.",
          ogTitle: 'Studio Monjo · équipe IA pour un studio à Séoul',
          ogDescription: "Cinq collègues IA nommés font tourner un studio de Séoul sur une machine locale Smart Fellow."
        },
        ko: {
          title: 'Studio Monjo · 서울 스튜디오의 AI 팀',
